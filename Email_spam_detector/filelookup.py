...
def find_value_with_csv(csv_file_path: str, search_key: str):
    ...
    """
    try:  #py keyword which continues execution even if an error occurs and doesnot terminate the program execution
    ...
    except FileNotFoundError:  #This block runs only if the CSV file does not exist 
                               #specific error 
    ...
    #except is a py keyword used in exceptional handling to catch errors
