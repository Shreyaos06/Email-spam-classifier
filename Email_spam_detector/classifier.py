...
class NaiveBayesSpamClassifier:
    ...
    def load_and_train(self):
        ...
        self.total_ham = 0
        self.vocab = set()
        with open(CSV_PATH, newline='', encoding='utf-8') as f:  #utf-8:type of info that can be stored like normal eng text,special characters,symbols,etc
    ...
    def predict(self, text):
        ...
        spam_or_ham = find_value_with_csv('user_feedback.csv', text)
        if spam_or_ham == 'spam':
            return 'SPAM'
